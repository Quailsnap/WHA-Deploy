...
wha_dp_fnc_addDeploy = COMPILE_FINAL "wha\deploy\functions\wha_dp_addDeploy.sqf";
wha_dp_fnc_addDeployGroup = COMPILE_FINAL "wha\deploy\functions\wha_dp_addDeployGroup.sqf";
wha_dp_fnc_deployLocal = COMPILE_FINAL "wha\deploy\functions\wha_dp_deployLocal.sqf";
wha_dp_fnc_teleportGroup = COMPILE_FINAL "wha\deploy\functions\wha_dp_teleportGroup.sqf";
wha_dp_fnc_teleportUnit = COMPILE_FINAL "wha\deploy\functions\wha_dp_teleportUnit.sqf";
wha_dp_fnc_teleportLocal = COMPILE_FINAL "wha\deploy\functions\wha_dp_teleportLocal.sqf";
